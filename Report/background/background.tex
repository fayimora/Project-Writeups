...
Indexing}} (LSI) and \textbf{\textit{Latent Dirichlet Allocation}} (LDA). LSI, also known as
\textit{Latent Semantic Analysis}, uses matrix-algebra computations to identify any patterns in
...
meanings~\cite{landauer2006latent,dumais2004latent}.
