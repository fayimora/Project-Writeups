...
As discussed in Section~\ref{sec:bg_naive_bayes}, a naive Bayes Classifier is a probabilistic
classifier which is based on the Bayes Theorem. We will train a naive Bayes classifier and use it to
classify the tweets into relevant and irrelevant groups.
