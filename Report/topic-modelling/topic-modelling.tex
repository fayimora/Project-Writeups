...
topics model. Forunately, there are a few simlar topics and \Tableref{tab:similar-topics} is a list
...
Specifically, we analyse rows 2, 6 and 7 from \Tableref{tab:similar-topics}
